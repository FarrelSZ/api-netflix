...
const checkFavoriteMovies = async (req, res) => {
  ...
  try {
    ...
    return OK(res, 200, { isFavorited }, "Check Favorite Movies Success");
  } catch (error) {
    return OK(res, 500, error, "Error Checking Favorite Movies ID");
  }
};
...
const SignInToken = async (req, res) => {
  try {
    ...
    return ERR(res, 401, "error sign in token");
  }
};
